...
object PropertyIndexedKeyframes {
  ...
  implicit class PropertyIndexedKeyframesOps[Self <: PropertyIndexedKeyframes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompositeVarargs(value: (CompositeOperation | Null)*): Self = this.set("composite", js.Array(value :_*))
    @scala.inline
    def setComposite(value: CompositeOperation | (js.Array[CompositeOperation | Null])): Self = this.set("composite", value.asInstanceOf[js.Any])
    @scala.inline
