...
trait Uint8ClampedArray extends /* index */ NumberDictionary[Double] {
  ...
  var toStringTag: org.scalablytyped.std.stdStrings.Uint8ClampedArray = js.native
  /** 
    ...
    */
  def copyWithin(target: Double, start: Double): Uint8ClampedArray = js.native
  def copyWithin(target: Double, start: Double, end: Double): Uint8ClampedArray = js.native
  /** 
  ...
  /**
    ...
    * length+end.
    */
  def fill(value: Double): Uint8ClampedArray = js.native
  def fill(value: Double, start: js.UndefOr[scala.Nothing], end: Double): Uint8ClampedArray = js.native
  def fill(value: Double, start: Double): Uint8ClampedArray = js.native
  def fill(value: Double, start: Double, end: Double): Uint8ClampedArray = js.native
  /**
  ...
  /**
    ...
    */
  def set(array: Uint8ClampedArray): Unit = js.native
  def set(array: Uint8ClampedArray, offset: Double): Unit = js.native
  /**
    * Sets a value or an array of values.
  ...
  /**
    ...
    */
  def sort(): Uint8ClampedArray = js.native
  def sort(compareFn: js.Function2[/* a */ Double, /* b */ Double, Double]): Uint8ClampedArray = js.native
  /**
