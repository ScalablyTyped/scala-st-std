...
trait CommandEvent extends Event {
  ...
  val detail: java.lang.String | Null
}
...
object CommandEvent {
  ...
  implicit class CommandEventOps[Self <: CommandEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDetailNull: Self = this.set("detail", null)
  }
