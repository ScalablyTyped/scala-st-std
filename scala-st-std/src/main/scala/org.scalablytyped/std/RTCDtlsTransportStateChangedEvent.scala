...
object RTCDtlsTransportStateChangedEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[RTCDtlsTransportStateChangedEvent]
  }
  @scala.inline
  implicit class RTCDtlsTransportStateChangedEventOps[Self <: RTCDtlsTransportStateChangedEvent] (val x: Self) extends AnyVal {
    @scala.inline
