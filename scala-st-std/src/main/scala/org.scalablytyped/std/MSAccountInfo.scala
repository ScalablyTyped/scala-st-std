...
object MSAccountInfo {
  @scala.inline
  def apply(rpDisplayName: java.lang.String, userDisplayName: java.lang.String): MSAccountInfo = {
    val __obj = js.Dynamic.literal(rpDisplayName = rpDisplayName.asInstanceOf[js.Any], userDisplayName = userDisplayName.asInstanceOf[js.Any])
