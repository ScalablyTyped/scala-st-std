...
trait Int8Array extends /* index */ NumberDictionary[Double] {
  ...
  var toStringTag: org.scalablytyped.std.stdStrings.Int8Array = js.native
  /** 
    ...
    */
  def copyWithin(target: Double, start: Double): Int8Array = js.native
  def copyWithin(target: Double, start: Double, end: Double): Int8Array = js.native
  /** 
  ...
  /**
    ...
    * length+end.
    */
  def fill(value: Double): Int8Array = js.native
  def fill(value: Double, start: js.UndefOr[scala.Nothing], end: Double): Int8Array = js.native
  def fill(value: Double, start: Double): Int8Array = js.native
  def fill(value: Double, start: Double, end: Double): Int8Array = js.native
  /**
  ...
  /**
    ...
    */
  def sort(): Int8Array = js.native
  def sort(compareFn: js.Function2[/* a */ Double, /* b */ Double, Double]): Int8Array = js.native
  /**
