...
/* Rewritten from type alias, can be one of: 
  ...
  - `org.scalablytyped`.std.stdStrings.`new`
*/
trait RTCIceTransportState extends js.Object

object RTCIceTransportState {
  @scala.inline
  def checking: org.scalablytyped.std.stdStrings.checking = "checking".asInstanceOf[org.scalablytyped.std.stdStrings.checking]
  @scala.inline
  def closed: org.scalablytyped.std.stdStrings.closed = "closed".asInstanceOf[org.scalablytyped.std.stdStrings.closed]
  @scala.inline
  def completed: org.scalablytyped.std.stdStrings.completed = "completed".asInstanceOf[org.scalablytyped.std.stdStrings.completed]
  @scala.inline
