...
object HTMLElementEventMap {
  ...
  @scala.inline
  implicit class HTMLElementEventMapOps[Self <: HTMLElementEventMap] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setContextmenu(value: PointerEvent): Self = this.set("contextmenu", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSelect(value: UIEvent): Self = this.set("select", value.asInstanceOf[js.Any])
    @scala.inline
