...
object NavigatorID {
  ...
  implicit class NavigatorIDOps[Self <: NavigatorID] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOscpu(value: java.lang.String): Self = this.set("oscpu", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTaintEnabled(value: () => scala.Boolean): Self = this.set("taintEnabled", js.Any.fromFunction0(value))
    @scala.inline
