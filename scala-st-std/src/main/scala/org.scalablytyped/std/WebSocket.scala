...
trait WebSocket extends EventTarget {
  ...
  def addEventListener_close(`type`: close, listener: js.Function1[/* ev */ CloseEvent, _]): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_close(`type`: close, listener: js.Function1[/* ev */ CloseEvent, _], useCapture: scala.Boolean): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_open(`type`: open, listener: js.Function1[/* ev */ Event, _]): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_open(`type`: open, listener: js.Function1[/* ev */ Event, _], useCapture: scala.Boolean): Unit = js.native
