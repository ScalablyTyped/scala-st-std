...
trait MSPointerEvent extends MouseEvent {
  var currentPoint: js.Any
  var height: Double
  var hwTimestamp: Double
  var intermediatePoints: js.Any
  var isPrimary: scala.Boolean
  var pointerId: Double
  var pointerType: js.Any
  var pressure: Double
  var rotation: Double
  var tiltX: Double
  var tiltY: Double
