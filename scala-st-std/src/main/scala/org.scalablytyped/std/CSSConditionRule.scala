...
object CSSConditionRule {
  ...
  implicit class CSSConditionRuleOps[Self <: CSSConditionRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConditionText(value: java.lang.String): Self = this.set("conditionText", value.asInstanceOf[js.Any])
  }
