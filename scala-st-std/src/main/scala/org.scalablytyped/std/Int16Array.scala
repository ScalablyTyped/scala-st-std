...
trait Int16Array extends /* index */ NumberDictionary[Double] {
  ...
  var toStringTag: org.scalablytyped.std.stdStrings.Int16Array = js.native
  /** 
    ...
    */
  def copyWithin(target: Double, start: Double): Int16Array = js.native
  def copyWithin(target: Double, start: Double, end: Double): Int16Array = js.native
  /** 
  ...
  /**
    ...
    * length+end.
    */
  def fill(value: Double): Int16Array = js.native
  def fill(value: Double, start: js.UndefOr[scala.Nothing], end: Double): Int16Array = js.native
  def fill(value: Double, start: Double): Int16Array = js.native
  def fill(value: Double, start: Double, end: Double): Int16Array = js.native
  /**
  ...
  /**
    ...
    */
  def sort(): Int16Array = js.native
  def sort(compareFn: js.Function2[/* a */ Double, /* b */ Double, Double]): Int16Array = js.native
  /**
