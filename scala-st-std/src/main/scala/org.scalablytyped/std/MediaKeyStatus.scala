...
object MediaKeyStatus {
  @scala.inline
  def expired: org.scalablytyped.std.stdStrings.expired = "expired".asInstanceOf[org.scalablytyped.std.stdStrings.expired]
  @scala.inline
  def `internal-error`: org.scalablytyped.std.stdStrings.`internal-error` = "internal-error".asInstanceOf[org.scalablytyped.std.stdStrings.`internal-error`]
  @scala.inline
  ...
  @scala.inline
  def usable: org.scalablytyped.std.stdStrings.usable = "usable".asInstanceOf[org.scalablytyped.std.stdStrings.usable]
}
