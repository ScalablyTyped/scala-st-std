...
trait NodeList extends /* index */ NumberDictionary[Node] {
  ...
  /**
    ...
    */
  def forEach(callbackfn: js.Function3[/* value */ Node, /* index */ Double, /* listObj */ this.type, Unit]): Unit = js.native
  def forEach(
    callbackfn: js.Function3[/* value */ Node, /* index */ Double, /* listObj */ this.type, Unit],
    thisArg: js.Any
  ): Unit = js.native
