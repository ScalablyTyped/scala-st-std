...
trait ExtendableMessageEventInit extends EventInit {
...
object ExtendableMessageEventInit {
  @scala.inline
  def apply(): ExtendableMessageEventInit = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExtendableMessageEventInit]
  }
  @scala.inline
  implicit class ExtendableMessageEventInitOps[Self <: ExtendableMessageEventInit] (val x: Self) extends AnyVal {
    @scala.inline
