...
trait WEBGLCompressedTextureS3tc extends js.Object {
  val COMPRESSED_RGBA_S3TC_DXT1_EXT: Double
  val COMPRESSED_RGBA_S3TC_DXT3_EXT: Double
  val COMPRESSED_RGBA_S3TC_DXT5_EXT: Double
  val COMPRESSED_RGB_S3TC_DXT1_EXT: Double
}
