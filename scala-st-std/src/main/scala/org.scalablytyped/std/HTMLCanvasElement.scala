...
trait HTMLCanvasElement extends HTMLElement {
  ...
  def getContext(contextId: java.lang.String, args: js.Any*): CanvasRenderingContext2D | WebGLRenderingContext = js.native
  /**
  ...
  @JSName("getContext")
  def getContext_experimentalwebgl(contextId: `experimental-webgl`): WebGLRenderingContext = js.native
  /**
