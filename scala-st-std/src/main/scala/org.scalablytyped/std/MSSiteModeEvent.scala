...
trait MSSiteModeEvent extends Event {
  val actionURL: java.lang.String
  val buttonID: Double
}

object MSSiteModeEvent {
  @scala.inline
  def apply(
    AT_TARGET: Double,
    ...
    val __obj = js.Dynamic.literal(AT_TARGET = AT_TARGET.asInstanceOf[js.Any], BUBBLING_PHASE = BUBBLING_PHASE.asInstanceOf[js.Any], CAPTURING_PHASE = CAPTURING_PHASE.asInstanceOf[js.Any], actionURL = actionURL.asInstanceOf[js.Any], bubbles = bubbles.asInstanceOf[js.Any], buttonID = buttonID.asInstanceOf[js.Any], cancelBubble = cancelBubble.asInstanceOf[js.Any], cancelable = cancelable.asInstanceOf[js.Any], currentTarget = currentTarget.asInstanceOf[js.Any], deepPath = js.Any.fromFunction0(deepPath), defaultPrevented = defaultPrevented.asInstanceOf[js.Any], eventPhase = eventPhase.asInstanceOf[js.Any], initEvent = js.Any.fromFunction3(initEvent), isTrusted = isTrusted.asInstanceOf[js.Any], preventDefault = js.Any.fromFunction0(preventDefault), returnValue = returnValue.asInstanceOf[js.Any], scoped = scoped.asInstanceOf[js.Any], stopImmediatePropagation = js.Any.fromFunction0(stopImmediatePropagation), stopPropagation = js.Any.fromFunction0(stopPropagation), target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[MSSiteModeEvent]
  }
  @scala.inline
  implicit class MSSiteModeEventOps[Self <: MSSiteModeEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setActionURL(value: java.lang.String): Self = this.set("actionURL", value.asInstanceOf[js.Any])
    @scala.inline
