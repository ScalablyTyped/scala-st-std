...
trait TextEvent extends UIEvent {
  var DOM_INPUT_METHOD_DROP: Double
  var DOM_INPUT_METHOD_HANDWRITING: Double
  var DOM_INPUT_METHOD_IME: Double
  var DOM_INPUT_METHOD_KEYBOARD: Double
  var DOM_INPUT_METHOD_MULTIMODAL: Double
  var DOM_INPUT_METHOD_OPTION: Double
  var DOM_INPUT_METHOD_PASTE: Double
  var DOM_INPUT_METHOD_SCRIPT: Double
  var DOM_INPUT_METHOD_UNKNOWN: Double
  var DOM_INPUT_METHOD_VOICE: Double
  var data: java.lang.String
  var inputMethod: Double
