...
trait ScriptNotifyEvent extends Event {
  val callingUri: java.lang.String
  val value: java.lang.String
}

object ScriptNotifyEvent {
  @scala.inline
  def apply(
    AT_TARGET: Double,
  ...
  implicit class ScriptNotifyEventOps[Self <: ScriptNotifyEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallingUri(value: java.lang.String): Self = this.set("callingUri", value.asInstanceOf[js.Any])
    @scala.inline
