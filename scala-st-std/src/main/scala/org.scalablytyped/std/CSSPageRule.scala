...
object CSSPageRule {
  ...
  @scala.inline
  implicit class CSSPageRuleOps[Self <: CSSPageRule] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPseudoClass(value: java.lang.String): Self = this.set("pseudoClass", value.asInstanceOf[js.Any])
    @scala.inline
