...
trait Int32Array extends /* index */ NumberDictionary[Double] {
  ...
  var toStringTag: org.scalablytyped.std.stdStrings.Int32Array = js.native
  /** 
    ...
    */
  def copyWithin(target: Double, start: Double): Int32Array = js.native
  def copyWithin(target: Double, start: Double, end: Double): Int32Array = js.native
  /** 
  ...
  /**
    ...
    * length+end.
    */
  def fill(value: Double): Int32Array = js.native
  def fill(value: Double, start: js.UndefOr[scala.Nothing], end: Double): Int32Array = js.native
  def fill(value: Double, start: Double): Int32Array = js.native
  def fill(value: Double, start: Double, end: Double): Int32Array = js.native
  /**
  ...
  /**
    ...
    */
  def sort(): Int32Array = js.native
  def sort(compareFn: js.Function2[/* a */ Double, /* b */ Double, Double]): Int32Array = js.native
  /**
