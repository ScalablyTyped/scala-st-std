...
trait IDBIndex extends js.Object {
  ...
  def openCursor(range: js.UndefOr[IDBValidKey], direction: IDBCursorDirection): IDBRequest[IDBCursorWithValue | Null] = js.native
  ...
  def openKeyCursor(range: js.UndefOr[IDBValidKey], direction: IDBCursorDirection): IDBRequest[IDBCursor | Null] = js.native
