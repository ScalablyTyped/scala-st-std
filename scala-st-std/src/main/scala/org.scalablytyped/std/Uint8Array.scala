...
trait Uint8Array extends /* index */ NumberDictionary[Double] {
  ...
  var toStringTag: UInt8Array = js.native
  /** 
    ...
    */
  def copyWithin(target: Double, start: Double): Uint8Array = js.native
  def copyWithin(target: Double, start: Double, end: Double): Uint8Array = js.native
  /** 
  ...
  /**
    ...
    * length+end.
    */
  def fill(value: Double): Uint8Array = js.native
  def fill(value: Double, start: js.UndefOr[scala.Nothing], end: Double): Uint8Array = js.native
  def fill(value: Double, start: Double): Uint8Array = js.native
  def fill(value: Double, start: Double, end: Double): Uint8Array = js.native
  /**
  ...
  /**
    ...
    */
  def sort(): Uint8Array = js.native
  def sort(compareFn: js.Function2[/* a */ Double, /* b */ Double, Double]): Uint8Array = js.native
  /**
