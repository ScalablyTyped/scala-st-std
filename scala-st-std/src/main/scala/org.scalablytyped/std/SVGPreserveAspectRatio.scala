...
trait SVGPreserveAspectRatio extends js.Object {
  var SVG_MEETORSLICE_MEET: Double
  var SVG_MEETORSLICE_SLICE: Double
  var SVG_MEETORSLICE_UNKNOWN: Double
  var SVG_PRESERVEASPECTRATIO_NONE: Double
  var SVG_PRESERVEASPECTRATIO_UNKNOWN: Double
  var SVG_PRESERVEASPECTRATIO_XMAXYMAX: Double
  var SVG_PRESERVEASPECTRATIO_XMAXYMID: Double
  var SVG_PRESERVEASPECTRATIO_XMAXYMIN: Double
  var SVG_PRESERVEASPECTRATIO_XMIDYMAX: Double
  var SVG_PRESERVEASPECTRATIO_XMIDYMID: Double
  var SVG_PRESERVEASPECTRATIO_XMIDYMIN: Double
  var SVG_PRESERVEASPECTRATIO_XMINYMAX: Double
  var SVG_PRESERVEASPECTRATIO_XMINYMID: Double
  var SVG_PRESERVEASPECTRATIO_XMINYMIN: Double
  var align: Double
