...
class OfflineAudioCompletionEvent ()
  extends org.scalablytyped.std.OfflineAudioCompletionEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var renderedBuffer: org.scalablytyped.std.AudioBuffer = js.native
  /* CompleteClass */
...
object OfflineAudioCompletionEvent
  extends Instantiable0[org.scalablytyped.std.OfflineAudioCompletionEvent]
