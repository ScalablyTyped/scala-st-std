...
@JSGlobal("HTMLNextIdElement")
@js.native
class HTMLNextIdElement ()
  extends org.scalablytyped.std.HTMLNextIdElement {
  /* CompleteClass */
...
@JSGlobal("HTMLNextIdElement")
@js.native
object HTMLNextIdElement
  extends Instantiable0[org.scalablytyped.std.HTMLNextIdElement]
