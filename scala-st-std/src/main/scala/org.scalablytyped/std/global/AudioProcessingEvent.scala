...
class AudioProcessingEvent ()
  ...
  /* CompleteClass */
  override val inputBuffer: org.scalablytyped.std.AudioBuffer = js.native
  /* CompleteClass */
  override val isTrusted: scala.Boolean = js.native
  /* CompleteClass */
  override val outputBuffer: org.scalablytyped.std.AudioBuffer = js.native
  /* CompleteClass */
  override val playbackTime: Double = js.native
  /* CompleteClass */
