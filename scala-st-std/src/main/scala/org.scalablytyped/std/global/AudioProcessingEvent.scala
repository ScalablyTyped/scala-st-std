...
class AudioProcessingEvent ()
  ...
  /* CompleteClass */
  override var inputBuffer: org.scalablytyped.std.AudioBuffer = js.native
  /* CompleteClass */
  override var isTrusted: scala.Boolean = js.native
  /* CompleteClass */
  override var outputBuffer: org.scalablytyped.std.AudioBuffer = js.native
  /* CompleteClass */
  override var playbackTime: Double = js.native
  /* CompleteClass */
