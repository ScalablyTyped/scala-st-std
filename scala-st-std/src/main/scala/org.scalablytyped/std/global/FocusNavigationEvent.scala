...
class FocusNavigationEvent protected ()
  extends org.scalablytyped.std.FocusNavigationEvent {
  ...
  /* CompleteClass */
  override val originLeft: Double = js.native
  /* CompleteClass */
  override val originTop: Double = js.native
  /* CompleteClass */
  override val originWidth: Double = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def requestFocus(): Unit = js.native
  /* CompleteClass */
...
object FocusNavigationEvent
  extends Instantiable1[/* type */ java.lang.String, org.scalablytyped.std.FocusNavigationEvent]
     with Instantiable2[
      /* type */ java.lang.String, 
      /* eventInitDict */ FocusNavigationEventInit, 
      org.scalablytyped.std.FocusNavigationEvent
    ]
