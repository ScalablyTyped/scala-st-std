...
class SVGClipPathElement ()
  extends org.scalablytyped.std.SVGClipPathElement {
  /* CompleteClass */
  override var SVG_UNIT_TYPE_OBJECTBOUNDINGBOX: Double = js.native
  /* CompleteClass */
  override var SVG_UNIT_TYPE_UNKNOWN: Double = js.native
  /* CompleteClass */
  override var SVG_UNIT_TYPE_USERSPACEONUSE: Double = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var transform: org.scalablytyped.std.SVGAnimatedTransformList = js.native
  /* CompleteClass */
...
object SVGClipPathElement
  extends Instantiable0[org.scalablytyped.std.SVGClipPathElement]
