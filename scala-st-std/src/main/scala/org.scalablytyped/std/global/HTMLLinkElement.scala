...
class HTMLLinkElement ()
  extends org.scalablytyped.std.HTMLLinkElement {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var sheet: org.scalablytyped.std.StyleSheet = js.native
  /* CompleteClass */
...
object HTMLLinkElement
  extends Instantiable0[org.scalablytyped.std.HTMLLinkElement]
