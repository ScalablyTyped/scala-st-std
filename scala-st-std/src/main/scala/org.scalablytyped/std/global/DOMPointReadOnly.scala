...
class DOMPointReadOnly ()
  extends org.scalablytyped.std.DOMPointReadOnly {
...
object DOMPointReadOnly
  extends Instantiable0[org.scalablytyped.std.DOMPointReadOnly]
     with Instantiable1[/* x */ Double, org.scalablytyped.std.DOMPointReadOnly]
     with Instantiable2[js.UndefOr[/* x */ Double], /* y */ Double, org.scalablytyped.std.DOMPointReadOnly]
     with Instantiable3[
      js.UndefOr[/* x */ Double], 
      js.UndefOr[/* y */ Double], 
      /* z */ Double, 
      org.scalablytyped.std.DOMPointReadOnly
    ]
     with Instantiable4[
      js.UndefOr[/* x */ Double], 
      js.UndefOr[/* y */ Double], 
  ...
  def fromPoint(): org.scalablytyped.std.DOMPointReadOnly = js.native
  def fromPoint(other: DOMPointInit): org.scalablytyped.std.DOMPointReadOnly = js.native
}
