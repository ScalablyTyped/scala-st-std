...
class PageTransitionEvent ()
  extends org.scalablytyped.std.PageTransitionEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var persisted: scala.Boolean = js.native
  /* CompleteClass */
...
object PageTransitionEvent
  extends Instantiable0[org.scalablytyped.std.PageTransitionEvent]
