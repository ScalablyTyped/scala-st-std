...
class MSMediaKeyMessageEvent ()
  extends org.scalablytyped.std.MSMediaKeyMessageEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val destinationURL: java.lang.String | Null = js.native
  /* CompleteClass */
  override val eventPhase: Double = js.native
  /* CompleteClass */
  override val isTrusted: scala.Boolean = js.native
  /* CompleteClass */
  override val message: org.scalablytyped.std.Uint8Array = js.native
  /* CompleteClass */
...
object MSMediaKeyMessageEvent
  extends Instantiable0[org.scalablytyped.std.MSMediaKeyMessageEvent]
