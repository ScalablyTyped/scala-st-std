...
@JSGlobal("MSHTMLWebViewElement")
@js.native
class MSHTMLWebViewElement ()
  extends org.scalablytyped.std.MSHTMLWebViewElement {
  /* CompleteClass */
...
@JSGlobal("MSHTMLWebViewElement")
@js.native
object MSHTMLWebViewElement
  extends Instantiable0[org.scalablytyped.std.MSHTMLWebViewElement]
