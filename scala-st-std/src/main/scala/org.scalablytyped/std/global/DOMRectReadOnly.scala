...
class DOMRectReadOnly ()
  extends org.scalablytyped.std.DOMRectReadOnly {
...
object DOMRectReadOnly
  extends Instantiable0[org.scalablytyped.std.DOMRectReadOnly]
     with Instantiable1[/* x */ Double, org.scalablytyped.std.DOMRectReadOnly]
     with Instantiable2[js.UndefOr[/* x */ Double], /* y */ Double, org.scalablytyped.std.DOMRectReadOnly]
     with Instantiable3[
      js.UndefOr[/* x */ Double], 
      js.UndefOr[/* y */ Double], 
      /* width */ Double, 
