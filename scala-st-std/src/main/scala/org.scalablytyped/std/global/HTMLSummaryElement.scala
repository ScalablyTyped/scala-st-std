...
@JSGlobal("HTMLSummaryElement")
@js.native
class HTMLSummaryElement ()
  extends org.scalablytyped.std.HTMLSummaryElement {
  /* CompleteClass */
...
@JSGlobal("HTMLSummaryElement")
@js.native
object HTMLSummaryElement
  extends Instantiable0[org.scalablytyped.std.HTMLSummaryElement]
