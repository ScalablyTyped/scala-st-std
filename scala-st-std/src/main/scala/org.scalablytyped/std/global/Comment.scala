...
@js.native
class Comment ()
  extends org.scalablytyped.std.CharacterData {
...
@js.native
object Comment
  extends Instantiable0[org.scalablytyped.std.Comment]
     with Instantiable1[/* data */ java.lang.String, org.scalablytyped.std.Comment]
