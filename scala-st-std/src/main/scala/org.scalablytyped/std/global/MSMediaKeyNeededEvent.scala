...
class MSMediaKeyNeededEvent ()
  extends org.scalablytyped.std.MSMediaKeyNeededEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val initData: org.scalablytyped.std.Uint8Array | Null = js.native
  /* CompleteClass */
...
object MSMediaKeyNeededEvent
  extends Instantiable0[org.scalablytyped.std.MSMediaKeyNeededEvent]
