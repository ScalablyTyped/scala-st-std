...
import org.scalablytyped.std.MediaEncryptedEventInit
...
class MediaEncryptedEvent protected ()
  extends org.scalablytyped.std.MediaEncryptedEvent {
  ...
  /* CompleteClass */
  override val initData: org.scalablytyped.std.ArrayBuffer | Null = js.native
  /* CompleteClass */
  override val initDataType: java.lang.String = js.native
  /* CompleteClass */
...
object MediaEncryptedEvent
  extends Instantiable1[/* type */ java.lang.String, org.scalablytyped.std.MediaEncryptedEvent]
     with Instantiable2[
      /* type */ java.lang.String, 
      /* eventInitDict */ MediaEncryptedEventInit, 
      org.scalablytyped.std.MediaEncryptedEvent
    ]
