...
import org.scalablytyped.std.MediaStreamEventInit
...
class MediaStreamEvent protected ()
  extends org.scalablytyped.std.MediaStreamEvent {
  ...
  /* CompleteClass */
  override val stream: org.scalablytyped.std.MediaStream | Null = js.native
  /* CompleteClass */
...
object MediaStreamEvent
  extends Instantiable2[
      ...
      org.scalablytyped.std.MediaStreamEvent
    ]
