...
@JSGlobal("MSSiteModeEvent")
@js.native
class MSSiteModeEvent ()
  extends org.scalablytyped.std.MSSiteModeEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val actionURL: java.lang.String = js.native
  /* CompleteClass */
...
object MSSiteModeEvent
  extends Instantiable0[org.scalablytyped.std.MSSiteModeEvent]
