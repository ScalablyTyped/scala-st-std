...
class IDBVersionChangeEvent ()
  extends org.scalablytyped.std.IDBVersionChangeEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val newVersion: Double | Null = js.native
  /* CompleteClass */
  override val oldVersion: Double = js.native
  /* CompleteClass */
...
object IDBVersionChangeEvent
  extends Instantiable0[org.scalablytyped.std.IDBVersionChangeEvent]
