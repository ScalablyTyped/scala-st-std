...
@JSGlobal("NavigationCompletedEvent")
@js.native
class NavigationCompletedEvent ()
  extends org.scalablytyped.std.NavigationCompletedEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val isSuccess: scala.Boolean = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val webErrorStatus: Double = js.native
  /* CompleteClass */
...
object NavigationCompletedEvent
  extends Instantiable0[org.scalablytyped.std.NavigationCompletedEvent]
