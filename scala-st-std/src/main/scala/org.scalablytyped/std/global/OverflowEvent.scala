...
@js.native
class OverflowEvent ()
  extends org.scalablytyped.std.OverflowEvent {
  /* CompleteClass */
  override val AT_TARGET: Double = js.native
  /* CompleteClass */
  override val BOTH: Double = js.native
  /* CompleteClass */
  override val BUBBLING_PHASE: Double = js.native
  /* CompleteClass */
  override val CAPTURING_PHASE: Double = js.native
  /* CompleteClass */
  override val HORIZONTAL: Double = js.native
  /* CompleteClass */
  override val VERTICAL: Double = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val horizontalOverflow: scala.Boolean = js.native
  /* CompleteClass */
  override val isTrusted: scala.Boolean = js.native
  /* CompleteClass */
  override val orient: Double = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val verticalOverflow: scala.Boolean = js.native
  /* CompleteClass */
...
object OverflowEvent
  extends Instantiable0[org.scalablytyped.std.OverflowEvent] {
