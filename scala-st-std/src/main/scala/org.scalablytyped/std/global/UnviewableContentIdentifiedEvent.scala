...
@JSGlobal("UnviewableContentIdentifiedEvent")
@js.native
class UnviewableContentIdentifiedEvent ()
  extends org.scalablytyped.std.UnviewableContentIdentifiedEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val mediaType: java.lang.String = js.native
  /* CompleteClass */
  override val referer: java.lang.String = js.native
  /* CompleteClass */
...
object UnviewableContentIdentifiedEvent
  extends Instantiable0[org.scalablytyped.std.UnviewableContentIdentifiedEvent]
