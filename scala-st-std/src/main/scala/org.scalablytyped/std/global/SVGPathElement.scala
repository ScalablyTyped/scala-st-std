...
class SVGPathElement ()
  extends org.scalablytyped.std.SVGPathElement {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val pathSegList: org.scalablytyped.std.SVGPathSegList = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val transform: org.scalablytyped.std.SVGAnimatedTransformList = js.native
  /* CompleteClass */
...
object SVGPathElement
  extends Instantiable0[org.scalablytyped.std.SVGPathElement]
