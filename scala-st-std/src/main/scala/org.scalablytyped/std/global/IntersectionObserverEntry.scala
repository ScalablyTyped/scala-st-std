...
class IntersectionObserverEntry protected ()
  ...
  /* CompleteClass */
  override val boundingClientRect: org.scalablytyped.std.DOMRectReadOnly = js.native
  /* CompleteClass */
  override val intersectionRatio: Double = js.native
  /* CompleteClass */
  override val intersectionRect: org.scalablytyped.std.DOMRectReadOnly = js.native
  /* CompleteClass */
  override val isIntersecting: scala.Boolean = js.native
  /* CompleteClass */
  override val rootBounds: org.scalablytyped.std.DOMRectReadOnly | Null = js.native
  /* CompleteClass */
