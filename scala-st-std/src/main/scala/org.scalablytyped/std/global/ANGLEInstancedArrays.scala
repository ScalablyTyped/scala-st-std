...
class ANGLEInstancedArrays ()
  ...
  /* CompleteClass */
  override def drawElementsInstancedANGLE(mode: Double, count: Double, `type`: Double, offset: Double, primcount: Double): Unit = js.native
  /* CompleteClass */
  override def vertexAttribDivisorANGLE(index: Double, divisor: Double): Unit = js.native
}
