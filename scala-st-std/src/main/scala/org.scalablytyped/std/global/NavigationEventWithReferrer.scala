...
@JSGlobal("NavigationEventWithReferrer")
@js.native
class NavigationEventWithReferrer ()
  extends org.scalablytyped.std.NavigationEventWithReferrer {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var referer: java.lang.String = js.native
  /* CompleteClass */
...
object NavigationEventWithReferrer
  extends Instantiable0[org.scalablytyped.std.NavigationEventWithReferrer]
