...
@JSGlobal("LongRunningScriptDetectedEvent")
@js.native
class LongRunningScriptDetectedEvent ()
  extends org.scalablytyped.std.LongRunningScriptDetectedEvent {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var executionTime: Double = js.native
  /* CompleteClass */
...
object LongRunningScriptDetectedEvent
  extends Instantiable0[org.scalablytyped.std.LongRunningScriptDetectedEvent]
