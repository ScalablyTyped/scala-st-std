...
trait Screen extends EventTarget {
  ...
  var onmsorientationchange: (js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]) | Null = js.native
  ...
  def lockOrientation(orientations: OrientationLockType): scala.Boolean = js.native
  def lockOrientation(orientations: js.Array[OrientationLockType]): scala.Boolean = js.native
