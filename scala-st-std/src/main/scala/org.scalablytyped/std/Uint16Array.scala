...
trait Uint16Array extends /* index */ NumberDictionary[Double] {
  ...
  var toStringTag: org.scalablytyped.std.stdStrings.Uint16Array = js.native
  /** 
    ...
    */
  def copyWithin(target: Double, start: Double): Uint16Array = js.native
  def copyWithin(target: Double, start: Double, end: Double): Uint16Array = js.native
  /** 
  ...
  /**
    ...
    * length+end.
    */
  def fill(value: Double): Uint16Array = js.native
  def fill(value: Double, start: js.UndefOr[scala.Nothing], end: Double): Uint16Array = js.native
  def fill(value: Double, start: Double): Uint16Array = js.native
  def fill(value: Double, start: Double, end: Double): Uint16Array = js.native
  /**
  ...
  /**
    ...
    */
  def sort(): Uint16Array = js.native
  def sort(compareFn: js.Function2[/* a */ Double, /* b */ Double, Double]): Uint16Array = js.native
  /**
