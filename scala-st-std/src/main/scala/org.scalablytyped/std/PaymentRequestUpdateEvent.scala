...
trait PaymentRequestUpdateEvent extends Event {
  def updateWith(d: js.Promise[PaymentDetails]): Unit
}
...
object PaymentRequestUpdateEvent {
  ...
  implicit class PaymentRequestUpdateEventOps[Self <: PaymentRequestUpdateEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUpdateWith(value: js.Promise[PaymentDetails] => Unit): Self = this.set("updateWith", js.Any.fromFunction1(value))
  }
