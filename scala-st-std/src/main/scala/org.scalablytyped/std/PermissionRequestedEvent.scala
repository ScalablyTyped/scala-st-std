...
object PermissionRequestedEvent {
  ...
  implicit class PermissionRequestedEventOps[Self <: PermissionRequestedEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPermissionRequest(value: PermissionRequest): Self = this.set("permissionRequest", value.asInstanceOf[js.Any])
  }
