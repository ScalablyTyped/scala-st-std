...
import org.scalablytyped.std.anon.CopyWithin
...
trait Array[T] extends /* n */ NumberDictionary[T] {
  ...
  /**
    ...
    */
  def concat(items: T*): js.Array[T] = js.native
  /**
    * Combines two or more arrays.
    * @param items Additional items to add to the end of array1.
    */
  ...
  /** 
    ...
    */
  def copyWithin(target: Double, start: Double): js.Array[T] = js.native
  def copyWithin(target: Double, start: Double, end: Double): js.Array[T] = js.native
  /** 
  ...
  /**
    ...
    * length+end.
    */
  def fill(value: T): js.Array[T] = js.native
  def fill(value: T, start: js.UndefOr[scala.Nothing], end: Double): js.Array[T] = js.native
  def fill(value: T, start: Double): js.Array[T] = js.native
  def fill(value: T, start: Double, end: Double): js.Array[T] = js.native
  /**
  ...
  /** 
    ...
    */
  def find(predicate: js.Function3[/* value */ T, /* index */ Double, /* obj */ js.Array[T], scala.Boolean]): T = js.native
  def find(
